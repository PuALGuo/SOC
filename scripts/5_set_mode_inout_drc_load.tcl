...
set_input_delay -clock hfextclk 0.5 [remove_from_collection [all_inputs][get_port "lfextclk"]]
set_output_delay -clock hfextclk 0.5 [all_outputs]
set_input_delay -clock lfextclk 0.5 [remove_from_collection [all_inputs][get_port "hfextclk"]]
