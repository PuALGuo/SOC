...
module e203_subsys_mems(
  ...
  // conv往mem的主从控制接口
  input                       conv_icb_cmd_valid,
  output                      conv_icb_cmd_ready,
  input  [32-1:0]             conv_icb_cmd_addr,
  input                       conv_icb_cmd_read,
  input  [32-1:0]             conv_icb_cmd_wdata,
  input  [4-1:0]              conv_icb_cmd_wmask,

  output                      conv_icb_rsp_valid,
  input                       conv_icb_rsp_ready,
  output [32-1:0]             conv_icb_rsp_rdata,
  //
  //////////////////////////////////////////////////////////
